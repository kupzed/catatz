...
| `AI_API_KEY` | Server-only | Yes untuk fitur AI | API key Gemini. Dipakai untuk Voice Input dan file Auto Fill melalui parser server-only. |
| `AI_MODEL` | Server-only | No | Model Gemini untuk Voice Input dan file Auto Fill. Default: `gemini-2.5-flash-lite`. |

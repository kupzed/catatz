...
Aplikasi saat ini berfokus pada pencatatan transaksi harian, pengelolaan rekening, kategori, hutang/piutang, rekap keuangan, pengaturan profil, export PDF/XLSX/CSV, dan pengalaman PWA.
...
- Pengguna yang ingin export laporan transaksi ke PDF, XLSX, atau CSV.
...
- Settings profil, avatar, password, tema, dan export PDF/XLSX/CSV.
